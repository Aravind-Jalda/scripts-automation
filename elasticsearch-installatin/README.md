...
```bash
0 2 * * * /path/to/install_elasticsearch.sh
```
...
* How to safely remove Elasticsearch
* Importance of cleaning residual data
* Repository-based installation vs manual install
* Service management using systemd
* Security defaults in Elasticsearch 8.x

---

## 📄 License

This project is for learning and personal DevOps automation purposes.
